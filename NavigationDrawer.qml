...
Rectangle{
    ...
    readonly property int _openMarginSize: 20*A.dp
    ...
    width: (Screen.width > Screen.height) ? 320*A.dp : Screen.width - 56*A.dp
    ...
    MouseArea {
        ...
        visible: (_rootItem.objectName!=='LoginPage'&&_rootItem.objectName!=='StartPage'&&_rootItem.objectName!=='SignUpPage') ? true : false
    ...
    Item {
        ...
        anchors.leftMargin: _rightEdge ? 0 : 10*A.dp
        height: parent.height
